...
| **Crow** | Crow | Hollow Knight | Crowant protector who watches, tests, and judges from the shadows — watching changes |
...
| V6 | Exponential Strategy Averaging (Crow) | Crow | Developer preference accumulation |
